...
FISHER_EXACT = Method("fisher_exact", "#637939")
...
PAIRWISE_PVALUE_METHODS = [
    MCNEMAR, FISHER_EXACT, BOOTSTRAP, BCA, BAYES_BOOTSTRAP, SMOOTH_BOOTSTRAP,
...
REPORT_METHOD_ORDER: list[Method] = BOOTSTRAP_METHODS + [
    ...
    MCNEMAR, FISHER_EXACT, PERMUTATION, SIGN_TEST, NEWCOMBE_PVAL, BAYES_BINARY, WILCOXON, PAIRED_T,
